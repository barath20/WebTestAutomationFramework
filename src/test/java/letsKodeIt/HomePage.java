...
public class HomePage extends Setup {
	...
	//
	// extendTest.log(Status.INFO, "Inside Radio...");
	//
	...
	//
	// extendTest.log(Status.INFO, "Inside Select1...");
	//
	...
	//
	// extendTest.log(Status.INFO, "Inside Select2...");
	//
	...
	//
	// extendTest.log(Status.INFO, "Inside Click2...");
	//
	...
	//
	// extendTest.log(Status.INFO, "Inside MouseHover...");
	//
	...
	//
	// pageDriver.DragAndDrop("//div[@id='draggable']", Locator.xpath,
	// "//div[@id='droppable']", Locator.xpath);
	// }
