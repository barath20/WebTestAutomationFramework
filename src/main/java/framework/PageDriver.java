...
public class PageDriver extends InitialSetup {
	...
	public void Click(WebElement element) throws Exception {
		try {
			...
			extendTest.log(Status.FAIL, "Error in Click() " + element);
		}
	}
	...
	public void SendKeys(WebElement element, String keys) {
		try {
			...
			extendTest.log(Status.FAIL, "Error in SendKeys() " + element);
		}
	}
	...
	public void Selects(WebElement element, int position) {
		try {
			...
			extendTest.log(Status.FAIL, "Error in Selects() " + element);
		}
	}
	...
	public void TakeScreenShot(String fileName) {
		...
		try {
			...
			extendTest.log(Status.FAIL, "Error during screenshot...");
		}
	}
	...
	public void MoveToElementPerform(WebElement element) {
		try {
			...
			extendTest.log(Status.FAIL, "Error in MoveToElementPerform() " + element);
		}
	}
	...
	public void MoveToElementClick(WebElement element) {
		try {
			...
			extendTest.log(Status.FAIL, "Error in MoveToElementClick() " + element);
		}
	}
	...
	public void DragAndDrop(WebElement fromElement, WebElement toElement) {
		try {
			...
			extendTest.log(Status.FAIL, "Error in DragAndDrop() " + fromElement + toElement);
		}
	}
	...
	public void Slider(WebElement element) {
		try {
			...
			extendTest.log(Status.FAIL, "Error in DragAndDrop() " + element);
		}
	}
}
